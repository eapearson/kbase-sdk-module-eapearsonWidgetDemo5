...
SERVICE_CAPS = eapearsonWidgetDemo5
SPEC_FILE = eapearsonWidgetDemo5.spec
URL = https://kbase.us/services/eapearsonwidgetdemo5
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
compile:
	...
	cp lib/eapearsonWidgetDemo5/eapearsonWidgetDemo5Server-ds.py lib/eapearsonWidgetDemo5/eapearsonWidgetDemo5Server.py
