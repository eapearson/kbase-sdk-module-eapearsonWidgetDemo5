...
class eapearsonWidgetDemo5:
    ...
    VERSION = "0.0.1"
    GIT_URL = ""
    GIT_COMMIT_HASH = "18ddf4c919f2556816e26e624601a9f30d4b0dfa"
    ...
    def run_eapearsonWidgetDemo5(self, ctx, params):
        """
        ...
        #BEGIN run_eapearsonWidgetDemo5
        ...
        #END run_eapearsonWidgetDemo5

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_eapearsonWidgetDemo5 return value ' +
